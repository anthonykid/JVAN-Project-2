...
public class katsp extends AppCompatActivity {
    ...
    public void tp_data(){
        ...
        Call<ResponProduk> tdata = arddata.katsp();
        ...
        tdata.enqueue(new Callback<ResponProduk>() {
            ...
            public void onResponse(Call<ResponProduk> call, Response<ResponProduk> response) {
                ...
                adp = new AdapterProduk2(katsp.this, listp);
            ...
            public void onFailure(Call<ResponProduk> call, Throwable t) {
                Toast.makeText(katsp.this, "GAGAL KONEK"+t.getMessage(), Toast.LENGTH_SHORT).show();
