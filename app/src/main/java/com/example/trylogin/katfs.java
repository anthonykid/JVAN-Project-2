...
public class katfs extends AppCompatActivity {
    ...
    public void tp_data(){
        ...
        Call<ResponProduk> tdata = arddata.katfs();
        ...
        tdata.enqueue(new Callback<ResponProduk>() {
            ...
            public void onResponse(Call<ResponProduk> call, Response<ResponProduk> response) {
                ...
                adp = new AdapterProduk2(katfs.this, listp);
            ...
            public void onFailure(Call<ResponProduk> call, Throwable t) {
                Toast.makeText(katfs.this, "GAGAL KONEK"+t.getMessage(), Toast.LENGTH_SHORT).show();
