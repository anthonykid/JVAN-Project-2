...
public class katln extends AppCompatActivity {
    ...
    public void tp_data(){
        ...
        Call<ResponProduk> tdata = arddata.katln();
        ...
        tdata.enqueue(new Callback<ResponProduk>() {
            ...
            public void onResponse(Call<ResponProduk> call, Response<ResponProduk> response) {
                ...
                adp = new AdapterProduk2(katln.this, listp);
            ...
            public void onFailure(Call<ResponProduk> call, Throwable t) {
                Toast.makeText(katln.this, "GAGAL KONEK"+t.getMessage(), Toast.LENGTH_SHORT).show();
