...
public class katbk extends AppCompatActivity {
    ...
    public void tp_data(){
        ...
        Call<ResponProduk> tdata = arddata.katb();
        ...
        tdata.enqueue(new Callback<ResponProduk>() {
            ...
            public void onResponse(Call<ResponProduk> call, Response<ResponProduk> response) {
                ...
                adp = new AdapterProduk2(katbk.this, listp);
            ...
            public void onFailure(Call<ResponProduk> call, Throwable t) {
                Toast.makeText(katbk.this, "GAGAL KONEK"+t.getMessage(), Toast.LENGTH_SHORT).show();
